...
#RUN mysqld_safe star --skip-grant-tables &
#RUN mysql -e "CREATE USER 'student'@'%' IDENTIFIED BY 'student@1';"
#RUN mysql -e "grant all privileges on studentapp.* to 'student'@'%' identified by 'student@1';"
